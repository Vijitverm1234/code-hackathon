  ...
  },
  {
    ...
    process: (
      <div>
        ...
        <ul>
          <li>• You are to build a web or mobile or desktop app ocxr a productivity framework that will help solve the challenges in any of the following domain</li>
          <li>
            • Clean Energy Solutions: Develop sustainable and renewable energy solutions tailored to the Eket region, whether it's solar, wind, or other clean energy sources. </li>

<li>•Waste Management Innovation: Create applications or devices that improve waste management processes, recycling, or waste-to-energy conversion within Eket.</li>

<li>•Smart Agriculture for Local Farmers: Build tech solutions that empower local farmers with data-driven insights, weather forecasts, and precision agriculture tools to enhance crop yields sustainably.</li>
...
<li>•Other domain</li>
        ...
        <ul>
          ...
          <h2> What to submit? </h2>
            <br />• A pitch deck explaining your project.
            <br />• Demo: You will demo and show the judges your project on the DevFest day. 
          </li>
          <br />
          <li>
...
Write up. <br>
Be sure to include a description of your project. Explain why you built your project and how it benefits the sector</br>
            <br />• Top 3 Rankers will get a chance to win USD 20,000.
          </li>
          <br />
          <br />
...
<li>● Technology students across India compete to creatively solve problems and offer technical solutions.</li>
    ...
    reward: (
      <div>
        <li>1st Position - N50,000.00 + DevFest Swag


</li>
        <li>2nd Position - N30,000.00 + DevFest Swag</li>
        <li>
        3rd Position - N20,000.00 + DevFest Swag
        </li>
